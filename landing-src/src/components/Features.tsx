...
const features = [
  {
    ...
    badge: null,
    desc: "Catches transactions and signature requests before your wallet signs them, then shows the verdict and the reasons. For a warning you choose to cancel or sign; a request that times out, or whose wallet chain is unknown or differs from the transaction's, is refused.",
    icon: "📡",
  },
  {
