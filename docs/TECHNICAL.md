...
- Top-10 holder concentration, tokens only (`top10_holder_percent`, from GoPlus's holder list): the share of supply its largest holders own, leaving out burn addresses, the chain adapter's known lockers, holders GoPlus marks locked and the token's DEX pairs and pool managers. 70% or more adds 10 points and 90% or more 20, with a flag. A missing or unreadable list is Unknown (structural coverage drops), never a spread-out token. On GoPlus data of 2026-09-24, 17 of the 20 benchmark safes read 3-66% and cbETH 91.5% (bridge and staking contracts); 7 of the 14 benchmark honeypots read 71-100%. No safe changes class (`tests/test_benchmark_safe_scores.py`).
