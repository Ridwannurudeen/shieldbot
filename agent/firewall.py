...
from core.policy import failed_sources
    ...
    async def agent_firewall(req: AgentFirewallRequest, request: Request):
        ...
        if from_db_cache:
            ...
            metadata = {
                ...
                # The failed required checks, which the firewall's STRICT check reads from the row.
                "failed_sources": failed_sources(results),
            }
